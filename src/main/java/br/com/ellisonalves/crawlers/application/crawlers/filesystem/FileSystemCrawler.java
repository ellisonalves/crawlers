...
public class FileSystemCrawler implements Crawlable {
    ...
    public void crawl(Map<String, Object> config) {
        ...
        Validate.notNull(initialPath, "Missing required parameter: initialPath = " + initialPath);
        Validate.notNull(searchDepth, "Missing required parameter: searchDepth = " + searchDepth);
